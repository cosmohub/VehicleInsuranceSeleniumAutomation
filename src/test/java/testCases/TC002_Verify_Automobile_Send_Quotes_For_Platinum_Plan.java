...
public class TC002_Verify_Automobile_Send_Quotes_For_Platinum_Plan extends BaseTest{
	...
	public Object[][] getTestData() throws FileNotFoundException, IOException {
		List<HashMap<String, String>> data = ExcelDataReader.testDataImporter("TC002_Verify_Automobile_Send_Quotes_For_Platinum_Plan");
